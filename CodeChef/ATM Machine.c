...
The second line contains N space-separated integers 1,2,…,A1,A2,…,A N

Output
For each test case, print a single line containing a string with length 
N. For each valid i, the i-th character of this string should be '1' if the 
...
10 units of money. The first person comes and withdraws 3
3 units, so the amount remaining in the machine is 7
7. Then the second person withdraws 5
5 units and the remaining amount is 2
2. The third person wants to withdraw 3
3 units, but since there are only 2
2 units of money in the machine, it throws an error and the third person must leave without getting anything. Then the fourth person withdraws 2
